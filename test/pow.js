...
test('Count zeros', async (assert) => {
  ...
  assert.equal(hex(h1), '00000e31f8ac983354f5885d46b7631bc75f69ec82e8f6178bae53db0ab7e054')
  ...
  assert.equal(hex(h2), '0000077b7d66117b57e45ccba0c31554e61c9853cc1cd9a2cf09c41b0aa9c22e')
  ...
  assert.equal(hex(h3), '000003bbf0cde49e3899ad23282b18defbc12a65f07c95d768464b87024df368')
  ...
  assert.equal(hex(h4), '000001e1084b865aba27df7a445753a24a3d89d63c7739a62c11dab3ee6eae32')
...
test('Vectors', async (assert) => {
  for (const vector of vectors) {
    ...
    assert.equal(hex(hash), vector.proof)
  }
