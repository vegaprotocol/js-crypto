...
test('Bad inputs', async (assert) => {
  ...
  assert.notOk(await pow.verify(3, '2E7A16D9EF690F0D2BEED115FBA13BA2AAA16C8F971910AD88C72B9DB010C7D4', '2E7A16D9EF690F0D2BEED115FBA13BA2AAA16C8F971910AD88C72B9DB010C7D4', 4n))
...
test('Count zeros', async (assert) => {
  ...
  assert.equal(toHex(h1), '00000e31f8ac983354f5885d46b7631bc75f69ec82e8f6178bae53db0ab7e054')
  ...
  assert.equal(toHex(h2), '0000077b7d66117b57e45ccba0c31554e61c9853cc1cd9a2cf09c41b0aa9c22e')
  ...
  assert.equal(toHex(h3), '000003bbf0cde49e3899ad23282b18defbc12a65f07c95d768464b87024df368')
  ...
  assert.equal(toHex(h4), '000001e1084b865aba27df7a445753a24a3d89d63c7739a62c11dab3ee6eae32')
...
test('Vectors', async (assert) => {
  for (const vector of vectors) {
    ...
    assert.equal(nonce, vector.nonce)
    const hash = await pow.hash(vector.blockHash, vector.tid, nonce)
    assert.equal(toHex(hash), vector.proof)
  }
