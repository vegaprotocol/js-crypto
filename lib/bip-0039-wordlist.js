 ...
 */
export async function generate(bits) {
 ...
 * @returns {Promise<string[]>}    List of mnemonic words. Normally joined into a single string delimited by spaces
 */
export async function toMnemonic (entropy) {
 ...
 */
export async function entropy (bits = 256) {
 ...
 */
export async function checksum (entropy) {
